...
const About = () => {
  useEffect(() => {
    ...
    return (
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4" data-aos="fade-up">
            <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12" data-aos="fade-up">
                ...
                <div className="w-full lg:w-6/12">
                    ...
                    <Image className="lg:hidden sm:block hidden w-full" src="https://i.ibb.co/16fPqrg/Rectangle-122-2.png" width={1000} height={1000} alt="people discussing on board" />
                    <Image className="sm:hidden block w-full" src="https://i.ibb.co/Jxhpxh6/Rectangle-122.png" width={1000} height={1000} alt="people discussing on board" />
                </div>
            </div>

            <div className="relative mt-24" data-aos="fade-up">
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4" data-aos="fade-up">
