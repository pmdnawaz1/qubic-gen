      ...
      {isMobile ? (
        ...
        <div className="flex items-center mt-10 justify-between mx-20 mb-10">
          ...
          <div className="flex items-center">
            <Image src={phoneicon} alt='mobile icon' className='bg-customColor w-12 p-3 rounded-3xl text-customColor' />
                ...
                >
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
                    <h4 className="text-3xl font-bold mb-4">
                      Where innovation meets compilance
                    </h4>
                    <button className="bg-[#650e32] text-white px-3 py-2 ">
                      Read more
                    </button>
                  </div>
                </div>
